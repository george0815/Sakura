...
void CPU_6502::BUILD_LOOKUP() {
  ...
  // LSR
  INSERT_INSTRUCTION(0xA2, "LSR", 2, &CPU_6502::LSR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LSR", 2, &CPU_6502::LSR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LSR", 2, &CPU_6502::LSR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LSR", 2, &CPU_6502::LSR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LSR", 2, &CPU_6502::LSR, &CPU_6502::IMMEDIATE);
  ...
  // ORA
  INSERT_INSTRUCTION(0xA2, "ORA", 2, &CPU_6502::ORA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ORA", 2, &CPU_6502::ORA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ORA", 2, &CPU_6502::ORA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ORA", 2, &CPU_6502::ORA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ORA", 2, &CPU_6502::ORA, &CPU_6502::IMMEDIATE);
  ...
  // STACK OPERATIONS
  INSERT_INSTRUCTION(0xA2, "LDX", 2, &CPU_6502::PHA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LDX", 2, &CPU_6502::PHP, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LDX", 2, &CPU_6502::PLA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "LDX", 2, &CPU_6502::PLP, &CPU_6502::IMMEDIATE);

  // ROL
  INSERT_INSTRUCTION(0xA2, "ROL", 2, &CPU_6502::ROL, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROL", 2, &CPU_6502::ROL, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROL", 2, &CPU_6502::ROL, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROL", 2, &CPU_6502::ROL, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROL", 2, &CPU_6502::ROL, &CPU_6502::IMMEDIATE);
  ...
  // ROR
  INSERT_INSTRUCTION(0xA2, "ROR", 2, &CPU_6502::ROR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROR", 2, &CPU_6502::ROR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROR", 2, &CPU_6502::ROR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROR", 2, &CPU_6502::ROR, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "ROR", 2, &CPU_6502::ROR, &CPU_6502::IMMEDIATE);
  ...
  // RTI/RTS
  INSERT_INSTRUCTION(0xA2, "RTI", 2, &CPU_6502::RTI, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "RTS", 2, &CPU_6502::RTS, &CPU_6502::IMMEDIATE);

  // SBC
  INSERT_INSTRUCTION(0xA2, "SBC", 2, &CPU_6502::SBC, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "SBC", 2, &CPU_6502::SBC, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "SBC", 2, &CPU_6502::SBC, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "SBC", 2, &CPU_6502::SBC, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "SBC", 2, &CPU_6502::SBC, &CPU_6502::IMMEDIATE);
  ...
  // STA
  INSERT_INSTRUCTION(0xA2, "STA", 2, &CPU_6502::STA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STA", 2, &CPU_6502::STA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STA", 2, &CPU_6502::STA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STA", 2, &CPU_6502::STA, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STA", 2, &CPU_6502::STA, &CPU_6502::IMMEDIATE);
  ...
  // STX
  INSERT_INSTRUCTION(0xA2, "STX", 2, &CPU_6502::STX, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STX", 2, &CPU_6502::STX, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STX", 2, &CPU_6502::STX, &CPU_6502::IMMEDIATE);

  // STY
  INSERT_INSTRUCTION(0xA2, "STY", 2, &CPU_6502::STY, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STY", 2, &CPU_6502::STY, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "STY", 2, &CPU_6502::STY, &CPU_6502::IMMEDIATE);
  ...
  // UNOFFICIAL NOP
  INSERT_INSTRUCTION(0xA2, "NOP", 2, &CPU_6502::NOP, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "NOP", 2, &CPU_6502::NOP, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "NOP", 2, &CPU_6502::NOP, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "NOP", 2, &CPU_6502::NOP, &CPU_6502::IMMEDIATE);
  INSERT_INSTRUCTION(0xA2, "NOP", 2, &CPU_6502::NOP, &CPU_6502::IMMEDIATE);
  ...
  /*
    ...
    // KIL
    INSERT_INSTRUCTION(0xA2, "KIL", 2, &CPU_6502::KIL, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "KIL", 2, &CPU_6502::KIL, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "KIL", 2, &CPU_6502::KIL, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "KIL", 2, &CPU_6502::KIL, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "KIL", 2, &CPU_6502::KIL, &CPU_6502::IMMEDIATE);
    ...
    // SLO
    INSERT_INSTRUCTION(0xA2, "SLO", 2, &CPU_6502::SLO, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SLO", 2, &CPU_6502::SLO, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SLO", 2, &CPU_6502::SLO, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SLO", 2, &CPU_6502::SLO, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SLO", 2, &CPU_6502::SLO, &CPU_6502::IMMEDIATE);
    ...
    // RLA
    INSERT_INSTRUCTION(0xA2, "RLA", 2, &CPU_6502::RLA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RLA", 2, &CPU_6502::RLA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RLA", 2, &CPU_6502::RLA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RLA", 2, &CPU_6502::RLA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RLA", 2, &CPU_6502::RLA, &CPU_6502::IMMEDIATE);
    ...
    // SRE
    INSERT_INSTRUCTION(0xA2, "SRE", 2, &CPU_6502::SRE, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SRE", 2, &CPU_6502::SRE, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SRE", 2, &CPU_6502::SRE, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SRE", 2, &CPU_6502::SRE, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SRE", 2, &CPU_6502::SRE, &CPU_6502::IMMEDIATE);
    ...
    // RRA
    INSERT_INSTRUCTION(0xA2, "RRA", 2, &CPU_6502::RRA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RRA", 2, &CPU_6502::RRA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RRA", 2, &CPU_6502::RRA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RRA", 2, &CPU_6502::RRA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "RRA", 2, &CPU_6502::RRA, &CPU_6502::IMMEDIATE);
    ...
    // SAX
    INSERT_INSTRUCTION(0xA2, "SAX", 2, &CPU_6502::SAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SAX", 2, &CPU_6502::SAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SAX", 2, &CPU_6502::SAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SAX", 2, &CPU_6502::SAX, &CPU_6502::IMMEDIATE);

    // LAX
    INSERT_INSTRUCTION(0xA2, "LAX", 2, &CPU_6502::LAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "LAX", 2, &CPU_6502::LAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "LAX", 2, &CPU_6502::LAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "LAX", 2, &CPU_6502::LAX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "LAX", 2, &CPU_6502::LAX, &CPU_6502::IMMEDIATE);
    ...
    // DCP
    INSERT_INSTRUCTION(0xA2, "DCP", 2, &CPU_6502::DCP, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "DCP", 2, &CPU_6502::DCP, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "DCP", 2, &CPU_6502::DCP, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "DCP", 2, &CPU_6502::DCP, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "DCP", 2, &CPU_6502::DCP, &CPU_6502::IMMEDIATE);
    ...
    // ISC
    INSERT_INSTRUCTION(0xA2, "ISC", 2, &CPU_6502::ISC, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "ISC", 2, &CPU_6502::ISC, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "ISC", 2, &CPU_6502::ISC, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "ISC", 2, &CPU_6502::ISC, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "ISC", 2, &CPU_6502::ISC, &CPU_6502::IMMEDIATE);
    ...
    // ANC
    INSERT_INSTRUCTION(0xA2, "ANC", 2, &CPU_6502::ANC, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "ANC", 2, &CPU_6502::ANC, &CPU_6502::IMMEDIATE);

    // ALR
    INSERT_INSTRUCTION(0xA2, "ALR", 2, &CPU_6502::ALR, &CPU_6502::IMMEDIATE);

    // ARR
    INSERT_INSTRUCTION(0xA2, "ARR", 2, &CPU_6502::ARR, &CPU_6502::IMMEDIATE);

    // AXS
    INSERT_INSTRUCTION(0xA2, "AXS", 2, &CPU_6502::AXS, &CPU_6502::IMMEDIATE);

    // LAS
    INSERT_INSTRUCTION(0xA2, "LAS", 2, &CPU_6502::LAS, &CPU_6502::IMMEDIATE);

    // SHX/SHY/TAS
    INSERT_INSTRUCTION(0xA2, "SHX", 2, &CPU_6502::SHX, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "SHY", 2, &CPU_6502::SHY, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "TAS", 2, &CPU_6502::TAS, &CPU_6502::IMMEDIATE);

    // XAA/LXA
    INSERT_INSTRUCTION(0xA2, "XAA", 2, &CPU_6502::XAA, &CPU_6502::IMMEDIATE);
    INSERT_INSTRUCTION(0xA2, "LXA", 2, &CPU_6502::LXA, &CPU_6502::IMMEDIATE); */
}
